...
joined_df[numeric_cols] = joined_df[numeric_cols].interpolate(
...
joined_df = joined_df.drop(
    columns=["city_name", "weather_main", "weather_description", "weather_icon"]
)
...
with SessionLocal() as session:
    joined_df.to_sql(
        "cleaned_data", session.get_bind(), if_exists="replace", index=False
    )
