...
def plot_correlation_matrix():
    ...
    ax.tick_params(axis='x', colors='#1c0858', labelsize=30)   # X-axis ticks in white color
    ax.tick_params(axis='y', colors='#1c0858',labelsize=30)  # Y-axis ticks in white color
    st.pyplot(fig)
